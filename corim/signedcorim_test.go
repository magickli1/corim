...
func certChain() []byte {
	result := make([]byte, len(testdata.IntermediateCA)+len(testdata.RootCA))
	copy(result, testdata.IntermediateCA)
	copy(result[len(testdata.IntermediateCA):], testdata.RootCA)
	return result
}
	   ...
	   18(
	     [
	       ...
	       / payload / << 501({
	         0: "test corim id",
	         1: [
	           506(h'')
	         ]
	       }) >>,
...
func TestSignedCorim_FromCOSE_fail_corim_bad_cbor(t *testing.T) {
	...
	*/
	tv := []byte{
		...
		0xc1, 0x1a, 0x5f, 0xad, 0x20, 0x56, 0xa0, 0x47, 0xd9, 0x01, 0xf5, 0xba,
...
func TestSignedCorim_FromCOSE_fail_invalid_corim(t *testing.T) {
	...
	*/
	tv := []byte{
		...
		0x2b, 0x63, 0x62, 0x6f, 0x72, 0x08, 0x57, 0xa2, 0x00, 0xa1, 0x00, 0x69,
		0x41, 0x43, 0x4d, 0x45, 0x20, 0x4c, 0x74, 0x64, 0x2e, 0x01, 0xa1, 0x01,
		0xc1, 0x1a, 0x5f, 0xad, 0x20, 0x56, 0xa0, 0x53, 0xd9, 0x01, 0xf5, 0xa1,
...
func TestSignedCorim_AddSigningCert(t *testing.T) {
	tests := []struct {
		...
		{"valid cert", testdata.EndEntityDer, false, ""},
...
func TestSignedCorim_AddIntermediateCerts(t *testing.T) {
	...
	tests := []struct {
		...
		// Positive test - valid certificate
		{"valid cert", testdata.IntermediateCA, false, "", 1},
...
func TestSignedCorim_SignVerify_with_x5chain_ok(t *testing.T) {
	...
	endEntityCert := testdata.EndEntityDer
